...
@NamedQueries({
    ...
    @NamedQuery(name = "Booking.sumsByPspAndDayForPersonAndTimePeriod", query = "SELECT b.day,t.psp,t.name,t.salesRepresentative,t.type,SUM(b.minutes) FROM Booking b,BookingTemplate t WHERE b.bookingTemplateId=t.id AND b.person=:person AND b.day>=:from AND b.day<:to GROUP BY b.day,t.psp,t.name,t.salesRepresentative,t.type ORDER BY t.psp,t.name,t.salesRepresentative,t.type,b.day"),
